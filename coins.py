...
"#game { width:100%; height:400px; background:#1e1e2f; border-radius:15px; border:3px solid #444; position:relative; overflow:hidden; touch-action:none; }",
...
"game.addEventListener('mousemove',e=>{ if(running) moveBag(e.clientX); });",
